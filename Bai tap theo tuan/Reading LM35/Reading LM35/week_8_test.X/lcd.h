...
#define LCD_D4       LATCbits.LATC2
#define LCD_D5       LATCbits.LATC1
#define LCD_D6       LATCbits.LATC0
#define LCD_D7       LATCbits.LATC3
...
#define LCD_RS       LATCbits.LATC7                     // LCD register select line
